...
if __name__ == "__main__":
    josn_path = "./train_data/guangdong1_round2_train1_20190924_Annotations/anno_train.json"
    ...
    for i in range(len(temps)):
        ...
        img_path = './train_data/guangdong1_round2_train1_20190924_images/' + img_name.split('.')[0]+'/'+temps[i]['name']
...
#                 print(type(k))
    ...
    with open("./train_data/guangdong1_round2_train1_20190924_Annotations/new.json", 'w') as f:
        print("dumped")
